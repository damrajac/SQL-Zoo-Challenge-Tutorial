...
SELECT name, gdp / population AS GDP_per_capita  -- Aliasing (i.e. using the AS keyword) in this task is optional
  FROM world
 WHERE population >= 200000000;
...
SELECT name, population / 1000000 AS pop_in_millions -- Aliasing (i.e. using the AS keyword) in this task is optional
  FROM world
...
SELECT name, ROUND(gdp/population, -3) -- This 'trick' with -3 rounds the number to the nearest thousand in this calculation
  FROM world
